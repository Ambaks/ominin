...
If graphify is not installed and set up yet, tell marwan to run his agent through its dedicated steps in AGENTS.md first to install graphify, then to try /marwan again. In this case, do not continue to step 2 and abort.
