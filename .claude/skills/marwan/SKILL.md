...
Explain to Marwan, my collaborator on this project (my name is Ambaka) what he has to do.
...
Use graphify, as you should, to get a clear understanding of the state of the project and the recent changes i have made.
If graphify is not installed and set up yet, tell marwan to run his agent through its dedicated steps in claude.md first to install graphify, then to try /marwan again. In this case, do not continue to step 2 and abort.
