...
export function CollectFinalCta() {
  return (
    ...
    >
      {/* Trame collect en filigrane, fondue sur les bords */}
      <div
        className="collect-dash-motif absolute inset-0 [mask-image:radial-gradient(ellipse_60%_70%_at_50%_50%,black,transparent)]"
        aria-hidden
      />
