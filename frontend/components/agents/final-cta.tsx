...
import { finalCta, signupCta } from "@/lib/agents-landing-data";
import { contactEmail } from "@/lib/landing-data";

export function AgentsFinalCta() {
  return (
    <section className="relative border-t border-hairline">
      <div
        className="agents-radar-motif absolute inset-0 [mask-image:radial-gradient(ellipse_60%_70%_at_50%_50%,black,transparent)]"
        aria-hidden
      />
