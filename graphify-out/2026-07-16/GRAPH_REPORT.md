# Graph Report - ominin  (2026-07-16)

## Corpus Check
- 211 files · ~165,291 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 993 nodes · 2307 edges · 118 communities (50 shown, 68 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 45 edges (avg confidence: 0.64)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `2311ff5f`
...
- [[_COMMUNITY_Commit Message Standard|Commit Message Standard]]
- [[_COMMUNITY_Project Upkeep Step|Project Upkeep Step]]
- [[_COMMUNITY_Commit Safety Checks|Commit Safety Checks]]
- [[_COMMUNITY_Watch Mode Auto-rebuild|Watch Mode Auto-rebuild]]
- [[_COMMUNITY_Neo4jFalkorDB Cypher Export|Neo4j/FalkorDB Cypher Export]]
- [[_COMMUNITY_MCP Graph Server|MCP Graph Server]]
- [[_COMMUNITY_Token Reduction Benchmark|Token Reduction Benchmark]]
- [[_COMMUNITY_Discrete Confidence Score Rubric|Discrete Confidence Score Rubric]]
- [[_COMMUNITY_Deterministic Node ID Format|Deterministic Node ID Format]]
- [[_COMMUNITY_Extraction Subagent Prompt|Extraction Subagent Prompt]]
- [[_COMMUNITY_Cross-repo Graph Merge|Cross-repo Graph Merge]]
- [[_COMMUNITY_GitHub Clone Flow|GitHub Clone Flow]]
...
- [[_COMMUNITY_QueryPathExplain Flow|Query/Path/Explain Flow]]
- [[_COMMUNITY_save-result Feedback Loop|save-result Feedback Loop]]
- [[_COMMUNITY_Work Memory (LESSONS.md Reflections)|Work Memory (LESSONS.md Reflections)]]
...
- [[_COMMUNITY_Cluster-only Rebuild|Cluster-only Rebuild]]
...
- [[_COMMUNITY_Community Detection and Clustering|Community Detection and Clustering]]
- [[_COMMUNITY_EXTRACTEDINFERREDAMBIGUOUS Taxonomy|EXTRACTED/INFERRED/AMBIGUOUS Taxonomy]]
- [[_COMMUNITY_Cumulative Cost Tracker|Cumulative Cost Tracker]]
- [[_COMMUNITY_Semantic Extraction Cache|Semantic Extraction Cache]]
- [[_COMMUNITY_Fast Path Query on Existing Graph|Fast Path Query on Existing Graph]]
- [[_COMMUNITY_God Nodes|God Nodes]]
- [[_COMMUNITY_Graph Health Check|Graph Health Check]]
- [[_COMMUNITY_graphify Skill|/graphify Skill]]
- [[_COMMUNITY_Semantic Extraction via Parallel Subagents|Semantic Extraction via Parallel Subagents]]
- [[_COMMUNITY_Graph Shrink Guard|Graph Shrink Guard]]
- [[_COMMUNITY_FastAPI Backend|FastAPI Backend]]
- [[_COMMUNITY_Claude API Integration|Claude API Integration]]
- [[_COMMUNITY_Project Skill Trigger Registry|Project Skill Trigger Registry]]
- [[_COMMUNITY_Code Quality Rules|Code Quality Rules]]
- [[_COMMUNITY_Environment-only Settings Convention|Environment-only Settings Convention]]
- [[_COMMUNITY_CORS Restricted to Frontend Origin|CORS Restricted to Frontend Origin]]
- [[_COMMUNITY_Next.js Frontend|Next.js Frontend]]
- [[_COMMUNITY_Graph-first Codebase Queries|Graph-first Codebase Queries]]
- [[_COMMUNITY_Supabase (DBAuthStorage)|Supabase (DB/Auth/Storage)]]
- [[_COMMUNITY_Push Workflow Rules|Push Workflow Rules]]
- [[_COMMUNITY_Next.js Agent Rules|Next.js Agent Rules]]
- [[_COMMUNITY_Frontend CLAUDE.md Include|Frontend CLAUDE.md Include]]
- [[_COMMUNITY_create-next-app Boilerplate README|create-next-app Boilerplate README]]
...
Cohesion: 0.13
Nodes (13): DishCard(), FeaturedCard(), ItemInput, Article, GestionState, Badge, BADGE_LABELS, MenuCategory (+5 more)
...
Cohesion: 0.07
Nodes (55): OnboardingForm(), metadata, OnboardingPage(), OrderCard(), PaymentDialog(), STATUS_CLASSES, StatusBadge(), ACTIVE_ORDER_STATUSES (+47 more)

### Community 86 - "useToast"
Cohesion: 0.07
Nodes (69): CommandesPage(), dedupeById(), FilterId, FILTERS, matchesFilter(), EquipePage(), ROLES, TeamManager() (+61 more)
...
Cohesion: 0.16
Nodes (13): ApercuIcon(), ChevronDownIcon(), CommandesIcon(), ExternalLinkIcon(), FormulesIcon(), GearIcon(), MenuIcon(), QrIcon() (+5 more)
...
Cohesion: 0.07
Nodes (51): GET(), GET(), POST(), POST(), GET(), POST(), POST(), POST() (+43 more)
...
Cohesion: 0.15
Nodes (12): providerApiKey(), PostStatus, PostSubmission, CAPTION_FIELDS, ClipProvider, ensureProfile(), isClipPlatform(), listConnectedAccounts() (+4 more)

### Community 94 - "page.tsx"
Cohesion: 0.11
Nodes (21): metadata, Features(), LandingFooter(), LandingNav(), Pricing(), Proof(), QrLive(), QrShowcase() (+13 more)

### Community 95 - "section-heading.tsx"
Cohesion: 0.23
Nodes (7): Faq(), HowItWorks(), SectionHeading(), faqSection, howItWorks, faqSection, howItWorks
...
Cohesion: 0.20
Nodes (13): AddToOrder(), isUnavailable(), OptionsModal(), CartBar(), PaymentChoice, SubmitState, CartChoice, CartConfig (+5 more)
...
Cohesion: 0.24
Nodes (9): generateMetadata(), getRestaurant, MenuPage(), Hero(), LANGUAGES, MenuFooter(), MenuSection(), CartProvider() (+1 more)
...
### Community 104 - "seed-demo.ts"
Cohesion: 0.43
Nodes (5): seed(), OrderItem, getRestaurant(), db, main()

### Community 105 - "qr-showcase.tsx"
Cohesion: 0.15
Nodes (17): apply(), fetchAnalytics(), generateCaptions(), pollPostStatus(), publishClip(), refreshAccounts(), requestLinkUrl(), retryPost() (+9 more)

### Community 106 - "data.ts"
Cohesion: 0.12
Nodes (20): metadata, DemoBanner(), emptySubscribe(), ClipData, ClipDataContext, ANALYTICS_BASE, buildDemoAnalytics(), buildDemoPosts() (+12 more)
...
Cohesion: 0.24
Nodes (7): POST(), CaptionEditor(), captionsSchema(), generateCaptions(), ClipUploadInput, CaptionSet, CLIP_PLATFORMS
...
Cohesion: 0.18
Nodes (7): AnalytiquePage(), compact, ComptesPage(), PublierPage(), PublicationsPage(), LinkIcon(), useClipData()

### Community 111 - "shell.tsx"
Cohesion: 0.20
Nodes (8): NAV_ITEMS, NavItem, signOut(), ChartIcon(), IconProps, LogoutIcon(), NavItem, ToastProvider()

### Community 112 - "icons.tsx"
Cohesion: 0.27
Nodes (7): Dropzone(), formatSize(), CheckIcon(), ListIcon(), RefreshIcon(), UploadIcon(), ACCEPTED_VIDEO_TYPES
...
## Knowledge Gaps
- **280 isolated node(s):** `backend`, `ResolvedLine`, `EXTENSIONS`, `Product`, `PRODUCTS_BY_CHOICE` (+275 more)
...
- **Why does `createClient()` connect `api.ts` to `add-to-order.tsx`, `store.ts`, `shell.tsx`, `auth-form.tsx`, `types.ts`, `useToast`, `shell.tsx`?**
  _High betweenness centrality (0.031) - this node is a cross-community bridge._
- **Why does `formatPrice()` connect `collect-experience.tsx` to `page.tsx`, `order-confirmation.tsx`, `add-to-order.tsx`, `types.ts`, `useToast`, `formule-form-modal.tsx`, `page.tsx`?**
