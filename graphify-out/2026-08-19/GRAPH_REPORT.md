...
## Summary
- 2883 nodes · 7343 edges · 151 communities (135 shown, 16 thin omitted)
...
Cohesion: 0.09
Nodes (48): CommandesPage(), dedupeById(), FilterId, FILTERS, matchesFilter(), EquipePage(), ROLES, TeamManager() (+40 more)
...
Cohesion: 0.13
Nodes (16): GET(), CollectPage(), generateMetadata(), getPage, CartLine, cartTotal(), CheckoutDialog(), CollectExperience() (+8 more)
...
Cohesion: 0.15
Nodes (19): as(), br(), checkSubtype(), error(), fr, gr, Ir(), is() (+11 more)
...
Cohesion: 0.17
Nodes (4): Settings, One-time Gmail OAuth consent — prints the refresh token to paste into env.  Usag, BaseSettings, eslintConfig
...
Cohesion: 0.16
Nodes (22): POST(), ResolvedLine, resolveOptions(), GET(), POST(), unsubscribe(), verifyToken(), AccountRow (+14 more)
...
### Community 92 - "get"
Cohesion: 0.40
Nodes (5): Ju(), rc(), serialize(), toArrayBuffer(), Yu()
...
Cohesion: 0.05
Nodes (55): ad, addCurrentVertex(), addHalfVertex(), addLine(), addToLineVertexArray(), addToSortKeyRanges(), angleTo(), bc() (+47 more)
...
Cohesion: 0.08
Nodes (34): am(), at(), bbox(), cm(), decode(), Dm(), getIlluminationProperties(), loadGeometry() (+26 more)
...
Cohesion: 0.10
Nodes (34): OrderCard(), CashDetails, PaymentDialog(), STATUS_CLASSES, StatusBadge(), PROVIDER_TAGLINES, StripeStatus, SumUpStatus (+26 more)
...
Cohesion: 0.10
Nodes (24): defines(), equals(), Es(), getBinderUniforms(), getBinding(), getUniforms(), gg(), height() (+16 more)
...
- **Why does `error()` connect `qr-showcase.tsx` to `types.ts`, `icons.tsx`, `types.ts`, `subdividePolygonInternal`?**
  _High betweenness centrality (0.191) - this node is a cross-community bridge._
- **Why does `push()` connect `addFeature` to `api.ts`, `types.ts`, `MenuItem`, `page.tsx`, `vh`, `sortFeatures`, `eslint.config.mjs`, `qr-showcase.tsx`, `order-card.tsx`, `update`, `theme-toggle.tsx`, `must`, `subdividePolygonInternal`, `getChildren`, `addLine`, `th`, `get`, `readPackedEnd`, `constructor`, `zn`, `hasDebugData`, `public-menu.ts`, `sub`, `clone`, `getValue`, `readPackedEnd`, `getColorRampTextures`, `extend`?**
