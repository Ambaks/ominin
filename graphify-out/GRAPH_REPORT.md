...
## Corpus Check
- 121 files · ~110,028 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 631 nodes · 1308 edges · 92 communities (26 shown, 66 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 20 edges (avg confidence: 0.76)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `2b125274`
...
## Communities (92 total, 66 thin omitted)
...
Cohesion: 0.07
Nodes (53): OnboardingForm(), metadata, STATUS_CLASSES, StatusBadge(), OFFRE_FEATURES, OFFRE_LABELS, ORDER_STATUS_FLOW, ORDER_STATUS_LABELS (+45 more)

### Community 86 - "useToast"
Cohesion: 0.06
Nodes (65): CommandesPage(), FilterId, FILTERS, matchesFilter(), EquipePage(), ROLES, TeamManager(), EtablissementForm() (+57 more)
...
Cohesion: 0.10
Nodes (32): ArticleDraft, draftToEtapes(), emptyArticle(), emptyEtape(), EtapeDraft, EtapeEditor(), etapesToDraft(), FormuleFormModal() (+24 more)

### Community 89 - "shell.tsx"
Cohesion: 0.13
Nodes (16): metadata, ApercuIcon(), CommandesIcon(), ExternalLinkIcon(), FormulesIcon(), GearIcon(), IconProps, LogoutIcon() (+8 more)
...
Cohesion: 0.11
Nodes (19): POST(), POST(), upsertSubscription(), GET(), generateMetadata(), getRestaurant, MenuPage(), OnboardingPage() (+11 more)
...
- **Why does `createClient()` connect `api.ts` to `shell.tsx`, `Menu Data & Components`, `types.ts`, `useToast`?**
