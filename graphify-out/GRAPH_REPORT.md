...
## Corpus Check
- 391 files · ~1,231,030 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3014 nodes · 7658 edges · 160 communities (142 shown, 18 thin omitted)
...
Cohesion: 0.08
Nodes (31): Ai(), Bu(), emplace(), feature(), getPositionIds(), getPositions(), hf(), interpolationFactor() (+23 more)
...
### Community 3 - "api.ts"
Cohesion: 0.10
Nodes (53): approveOutreachEmail(), fetchAllSlugs(), importRestaurants(), rejectOutreachEmail(), updateOutreachDraft(), addTableToGroup(), apply(), assertTransition() (+45 more)
...
Cohesion: 0.23
Nodes (11): CuisinierApercu(), EmployeeApercu(), EmptyService(), LiveTile(), riseDelay(), ServeurApercu(), ServiceClock(), KitchenBoard() (+3 more)

### Community 7 - "data.ts"
Cohesion: 0.18
Nodes (11): at(), Dm(), equals(), getIlluminationProperties(), height(), mc(), pc(), sn() (+3 more)
...
Cohesion: 0.08
Nodes (23): metadata, NAV_ITEMS, signOut(), ApercuIcon(), BellIcon(), ChartIcon(), ChevronDownIcon(), CommandesIcon() (+15 more)
...
Cohesion: 0.08
Nodes (24): AnalyticsView, AnalytiquePage(), compact, PostAnalyticsList(), VIEW_SUBTITLES, VIEWS, ComptesPage(), PublicationsPage() (+16 more)
...
Cohesion: 0.18
Nodes (19): POST(), DELETE(), GET(), POST(), requireUser(), AccountRow, GET(), paymentAccounts() (+11 more)
...
Cohesion: 0.08
Nodes (39): POST(), ChimeCard(), IOS_STEPS, CHIME_NOTES, chimeEnabled(), chimeListeners, playChime(), setChimeEnabled() (+31 more)
...
Cohesion: 0.08
Nodes (31): ClientDemoPage(), ConfirmationPage(), metadata, CollectPage(), generateMetadata(), getPage, generateMetadata(), getRestaurant (+23 more)

### Community 26 - "collect-experience.tsx"
Cohesion: 0.12
Nodes (10): GenerateurPage(), MOMENTS, STEPS, ComptesTab, TABS, PublierTab, PublierTabs(), TABS (+2 more)

### Community 27 - "selectors.ts"
Cohesion: 0.12
Nodes (21): ApercuPage(), Period, TableGrid(), TableGroupCard(), ANALYTICS_PERIOD_DAYS, DayPoint, dayStart(), freeTables() (+13 more)
...
Cohesion: 0.23
Nodes (10): POST(), ResolvedLine, resolveOptions(), GET(), isCollectActive(), CartChoice, CartLinePayload, CollectCheckoutPayload (+2 more)
...
Cohesion: 0.09
Nodes (40): EtablissementForm(), DevicesCard(), DeviceStatusCard(), PrefsCard(), NoteComposer, CreateRestaurantModal(), DUPLICATE_REASON_LABELS, CollectSettings() (+32 more)

### Community 67 - "Tt"
Cohesion: 0.07
Nodes (45): InvitationForm(), InvitationPage(), OnboardingForm(), RESERVED_SLUGS, metadata, OnboardingPage(), StaffPending(), OrderCardDemo() (+37 more)

### Community 68 - "format.ts"
Cohesion: 0.10
Nodes (37): ApercuPage(), dayTitle(), groupByDay(), RdvPage(), STATUS_CLASSES, TabId, TachesPage(), PlusIcon() (+29 more)

### Community 69 - "useAdmin"
Cohesion: 0.07
Nodes (32): EmailsPage(), Analysis, ImportPage(), ParsedRow, Phase, RowStatus, STATUS_META, COLUMNS (+24 more)

### Community 70 - "lead-panel.tsx"
Cohesion: 0.09
Nodes (32): metadata, ArrowRightIcon(), CalendarIcon(), ChevronLeftIcon(), ClockIcon(), GlobeIcon(), ImportIcon(), MailIcon() (+24 more)
...
Cohesion: 0.07
Nodes (43): createTree(), ey(), finish(), Jv(), loadGeometry(), qv(), realloc(), ty() (+35 more)

### Community 73 - "theme-toggle.tsx"
Cohesion: 0.18
Nodes (22): ACTIVE_ORDER_STATUSES, HISTORY_ORDER_STATUSES, assembleGroups(), OrderRow, rowToEtablissement(), rowToFormule(), rowToOrder(), rowToTable() (+14 more)

### Community 74 - "fire"
Cohesion: 0.05
Nodes (38): CartLine, cartTotal(), CheckoutDialog(), CollectExperience(), ItemRow(), SelectedChoice, OrderConfirmation(), STATUS_COPY (+30 more)

### Community 75 - "push"
Cohesion: 0.13
Nodes (16): EXTENSIONS, POST(), POST(), POST(), Product, PRODUCTS_BY_CHOICE, GET(), ClipEspaceLayout() (+8 more)

### Community 76 - "ja"
Cohesion: 0.26
Nodes (17): ee(), f(), gc, gl(), ib(), interpolate(), l(), m() (+9 more)
...
Cohesion: 0.07
Nodes (34): TabId, statusColorExpression, Viewport, StatusMenu(), ALL_COLUMNS, PipelineBoard(), DragState, useBoardDrag() (+26 more)

### Community 80 - "must"
Cohesion: 0.05
Nodes (93): ac(), add(), ax, bb(), bs(), bx(), concat(), containsPolygonGeometry() (+85 more)
...
Cohesion: 0.13
Nodes (16): seed(), OrderItem, getRestaurant(), CompositeTypes, Constants, DatabaseWithoutInternals, DefaultSchema, Enums (+8 more)
...
Cohesion: 0.16
Nodes (20): A(), C(), ct(), D(), E(), g(), jc(), k() (+12 more)
...
### Community 92 - "get"
Cohesion: 0.12
Nodes (21): FilterBar(), FilterIcon(), SearchIcon(), NO_CONTACT_OPTIONS, countActiveFilters(), emptyFilters(), filterLeads(), filters (+13 more)
...
### Community 97 - "zn"
Cohesion: 0.27
Nodes (10): _addCollisionDebugVertex(), addCollisionDebugVertices(), addSymbols(), av(), emplaceBack(), forceNewSegmentOnNextPrepare(), iv(), kc() (+2 more)
...
Cohesion: 0.16
Nodes (19): CartePage(), MapCanvas, CrosshairIcon(), FollowUpChoice, VisitedFlow(), MarkVisitedInput, FOLLOW_UP_QUICK_OPTIONS, fromDatetimeLocalValue() (+11 more)

### Community 109 - "Yf"
Cohesion: 0.12
Nodes (18): addImages(), backfillBorder(), calculateScaledKey(), constructor(), copy(), df(), ff(), _idx() (+10 more)
...
### Community 116 - "Bd"
Cohesion: 0.20
Nodes (9): PublierPage(), CaptionEditor(), PlatformBadge(), STATUS_CLASSES, PLATFORM_LABELS, STATUS_LABELS, ClipUploadInput, ClipPlatform (+1 more)
...
### Community 120 - "b"
Cohesion: 0.17
Nodes (15): b(), Cy(), determineAverageLineWidth(), determineLineBreaks(), getMaxImageSize(), getMaxScale(), getSection(), getSectionIndex() (+7 more)
...
### Community 132 - "uo"
Cohesion: 0.11
Nodes (30): addLineDashDependencies(), bo(), _calculate(), calculateGlyphDependencies(), ci(), constantOr(), createArrays(), dc() (+22 more)
...
Cohesion: 0.11
Nodes (24): am(), cg(), defines(), dg(), Es(), fg(), getBinderUniforms(), getData() (+16 more)

### Community 144 - "O"
Cohesion: 0.18
Nodes (13): ProduitsPage(), ExternalLinkIcon(), DiscoverLink(), Pill(), ProductCard(), startCheckout(), ROLE_TAGLINES, allowedActions() (+5 more)

### Community 145 - "getPaintAffectingGlobalStateRefs"
Cohesion: 0.06
Nodes (38): an(), completeTask(), containsMaxSafeIntegerValues(), deserialize(), en(), fn(), freeBufferAfterUpload(), getFeatures() (+30 more)
...
Cohesion: 0.18
Nodes (11): appendLeaves(), cluster(), getChildren(), getLeaves(), getOriginId(), ng(), Qh(), sh() (+3 more)
...
- **Why does `error()` connect `readPackedEnd` to `subdividePolygonInternal`, `theme-toggle.tsx`, `formatPrice`, `types.ts`?**
  _High betweenness centrality (0.216) - this node is a cross-community bridge._
- **Why does `push()` connect `addFeature` to `useGestionAccess`, `uo`, `data.ts`, `zn`, `types.ts`, `getPaintAffectingGlobalStateRefs`, `shell.tsx`, `eslint.config.mjs`, `getOriginZoom`, `demo-showcase.tsx`, `order-card.tsx`, `database.types.ts`, `ja`, `must`, `subdividePolygonInternal`, `shell.tsx`, `addLine`, `getStripe`, `th`, `readPackedEnd`, `zn`, `constructor`, `hasDebugData`, `Od`, `clone`, `Yf`, `readPackedEnd`, `getColorRampTextures`, `b`, `lb`, `_getWorkerSource`, `extend`?**
