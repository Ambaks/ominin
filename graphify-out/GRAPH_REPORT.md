...
## Summary
- 1371 nodes · 3055 edges · 133 communities (67 shown, 66 thin omitted)
...
- `run_worker()` --calls--> `create_supabase()`  [INFERRED]
  clipper/clipper/worker.py → clipper/clipper/common/supabase_client.py
- `ClassifyResponse` --uses--> `JobUpdater`  [INFERRED]
  clipper/clipper/stages/fuse.py → clipper/clipper/common/supabase_client.py

## Import Cycles
- None detected.

## Communities (133 total, 66 thin omitted)
...
Cohesion: 0.05
Nodes (97): OnboardingForm(), metadata, OnboardingPage(), STATUS_CLASSES, StatusBadge(), addTableToGroup(), apply(), assertTransition() (+89 more)

### Community 86 - "useToast"
Cohesion: 0.05
Nodes (73): PublicationsPage(), AnalytiquePage(), Period, CommandesPage(), dedupeById(), FilterId, FILTERS, matchesFilter() (+65 more)
...
Cohesion: 0.22
Nodes (9): create_anthropic(), Anthropic, Settings, strict_json_call(), JudgedManifest, Path, Settings, run() (+1 more)
...
Cohesion: 0.09
Nodes (28): metadata, ClipFaq(), ClipFeatures(), ClipFinalCta(), ClipFooter(), ClipHero(), ClipNav(), ClipPricing() (+20 more)
...
Cohesion: 0.08
Nodes (25): metadata, metadata, Faq(), HowItWorks(), LandingFooter(), Pricing(), Proof(), QrLive() (+17 more)
...
Cohesion: 0.60
Nodes (4): DeliverableManifest, _get_user_id(), Path, run()

### Community 97 - "shell.tsx"
Cohesion: 0.10
Nodes (32): crop_vertical(), duration_s(), extract_audio_16k(), extract_thumbnail(), probe(), Path, require_ffmpeg(), load_settings() (+24 more)

### Community 98 - "Sensor"
Cohesion: 0.14
Nodes (22): ABC, SensorOutput, SignalEvent, SignalPoint, _burst(), merge_burst_events(), ndarray, Merge consecutive above-threshold windows into single events. (+14 more)
...
Cohesion: 0.11
Nodes (9): Settings, BaseSettings, Settings, _content_type(), create_supabase(), JobUpdater, Path, Settings (+1 more)
...
Cohesion: 0.14
Nodes (17): RankedClip, RankedManifest, RefinedCandidatesManifest, RenderedClip, Segment, SignalsManifest, Word, _load_ranking_config() (+9 more)

### Community 116 - "MediaManifest"
Cohesion: 0.33
Nodes (11): BaseModel, Judge, JudgeResponse, _load_prompt(), _mmss(), Anthropic, TextOnlyJudge, JudgedCandidate (+3 more)
...
Cohesion: 0.21
Nodes (8): ClipHowItWorks(), Features(), SectionHeading(), Testimonials(), featuresSection, howItWorks, clientsSection, featuresSection

### Community 125 - "TranscriptManifest"
Cohesion: 0.35
Nodes (9): TranscriptManifest, Path, _find_setup_start(), Path, run(), _segment_at(), _snap_to_sentence_end(), _snap_to_sentence_start() (+1 more)
...
- **Why does `Client` connect `JobUpdater` to `types.ts`?**
  _High betweenness centrality (0.156) - this node is a cross-community bridge._
- **Why does `JobUpdater` connect `JobUpdater` to `demo-showcase.tsx`, `shell.tsx`, `schemas.py`, `run`, `demo-showcase.tsx`, `TranscriptManifest`?**
  _High betweenness centrality (0.151) - this node is a cross-community bridge._
- **Why does `createClient()` connect `types.ts` to `add-to-order.tsx`, `auth-form.tsx`, `store.ts`, `useToast`, `api.ts`, `shell.tsx`, `selectors.ts`?**
