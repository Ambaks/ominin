# Graph Report - ominin  (2026-08-19)

## Corpus Check
- 374 files · ~1,215,404 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2912 nodes · 7400 edges · 167 communities (147 shown, 20 thin omitted)
- Extraction: 96% EXTRACTED · 4% INFERRED · 0% AMBIGUOUS · INFERRED: 283 edges (avg confidence: 0.58)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `091d3e3b`
...
### Community 3 - "api.ts"
Cohesion: 0.14
Nodes (45): approveOutreachEmail(), rejectOutreachEmail(), updateImportantNotes(), updateOutreachDraft(), addTableToGroup(), apply(), assertTransition(), createCategory() (+37 more)
...
Cohesion: 0.12
Nodes (27): addLineDashDependencies(), _calculate(), calculateGlyphDependencies(), constantOr(), createArrays(), dc(), di(), evaluate() (+19 more)
...
Cohesion: 0.08
Nodes (50): EmailsPage(), CommandesPage(), dedupeById(), FilterId, FILTERS, matchesFilter(), EquipePage(), ROLES (+42 more)

### Community 25 - "icons.tsx"
Cohesion: 0.08
Nodes (31): GET(), CartLine, cartTotal(), CheckoutDialog(), CollectExperience(), ItemRow(), SelectedChoice, OrderCardDemo() (+23 more)

### Community 26 - "collect-experience.tsx"
Cohesion: 0.11
Nodes (21): ProduitsPage(), OnboardingForm(), RESERVED_SLUGS, metadata, OnboardingPage(), CheckIcon(), SubscriptionGate(), DiscoverLink() (+13 more)
...
Cohesion: 0.10
Nodes (31): InvitationForm(), InvitationPage(), PROVIDER_TAGLINES, StripeStatus, SumUpStatus, ACTION_FEATURE, ACTION_LABELS, ACTIVE_ORDER_STATUSES (+23 more)

### Community 34 - "auth-form.tsx"
Cohesion: 0.08
Nodes (17): metadata, metadata, metadata, metadata, metadata, metadata, metadata, AuthForm() (+9 more)

### Community 35 - "loading.tsx"
Cohesion: 0.14
Nodes (18): ExportRow, fetchOutreachEmails(), fetchOutreachProspects(), fetchOutreachRuns(), LEAD_LITE_SELECT, LeadLiteJoinRow, rowToOutreachEmail(), rowToOutreachProspect() (+10 more)
...
Cohesion: 0.40
Nodes (5): am(), at(), Dm(), getIlluminationProperties(), sn()
...
Cohesion: 0.12
Nodes (34): ActivityInput, addActivity(), apply(), AppointmentInput, completeTask(), createAppointment(), createTask(), DuplicateCandidate (+26 more)
...
Cohesion: 0.07
Nodes (35): ClientDemoPage(), ConfirmationPage(), metadata, CollectPage(), generateMetadata(), getPage, generateMetadata(), getRestaurant (+27 more)
...
Cohesion: 0.06
Nodes (46): ad, addCurrentVertex(), addHalfVertex(), addLine(), Bd(), clone(), convert(), Dd() (+38 more)

### Community 58 - "formatPrice"
Cohesion: 0.22
Nodes (18): signOut(), adminLoginPath(), commit(), fetchAll(), fetchLeads(), fetchOpenTasks(), fetchPendingDraftCount(), fetchUpcomingAppointments() (+10 more)

### Community 63 - "order-card.tsx"
Cohesion: 0.12
Nodes (24): Aa(), ba(), bind(), canonicalID(), da(), ea, ga(), geometry() (+16 more)
...
Cohesion: 0.09
Nodes (35): ArticleDraft, draftToEtapes(), emptyArticle(), emptyEtape(), EtapeDraft, EtapeEditor(), etapesToDraft(), FormuleFormModal() (+27 more)

### Community 67 - "Tt"
Cohesion: 0.13
Nodes (18): CartePage(), ImportPage(), metadata, RdvPage(), RestaurantsPage(), TachesPage(), ALL_COLUMNS, PipelineBoard() (+10 more)

### Community 68 - "format.ts"
Cohesion: 0.10
Nodes (36): ApercuPage(), dayTitle(), groupByDay(), STATUS_CLASSES, TabId, MapLeadCard(), PlusIcon(), FollowUpChoice (+28 more)
...
Cohesion: 0.09
Nodes (32): ArrowRightIcon(), CalendarIcon(), ChevronLeftIcon(), ClockIcon(), GlobeIcon(), MailIcon(), MapPinIcon(), NoteIcon() (+24 more)

### Community 71 - "update"
Cohesion: 0.09
Nodes (29): ap(), bp(), cp(), createNewSegment(), dp, ep, forceNewSegmentOnNextPrepare(), getOrCreateLatestSegment() (+21 more)
...
Cohesion: 0.20
Nodes (21): assembleCategories(), assembleGroups(), OrderRow, rowToEtablissement(), rowToFormule(), rowToOrder(), rowToTable(), commit() (+13 more)
...
### Community 76 - "ja"
Cohesion: 0.15
Nodes (35): b(), C(), ct(), D(), E(), emplaceBack(), f(), g() (+27 more)
...
Cohesion: 0.07
Nodes (44): TabId, statusColorExpression, Viewport, StatusMenu(), RestaurantPicker(), CreateRestaurantModal(), DUPLICATE_REASON_LABELS, LeadStatusBadge() (+36 more)

### Community 80 - "must"
Cohesion: 0.08
Nodes (29): Ai(), bm(), Bu(), Em(), fromLngLat(), gm(), hm(), interpolationFactor() (+21 more)
...
Cohesion: 0.11
Nodes (22): fetchClosedTasks(), findDuplicates(), seed(), getRestaurant(), TablesInsert, must(), Category, daysAgo() (+14 more)

### Community 86 - "getStripe"
Cohesion: 0.16
Nodes (21): POST(), ResolvedLine, resolveOptions(), AccountRow, GET(), paymentAccounts(), POST(), requireGerant() (+13 more)
...
Cohesion: 0.11
Nodes (19): addImages(), backfillBorder(), calculateScaledKey(), constructor(), _down(), _getByteView(), getPixels(), _idx() (+11 more)

### Community 90 - "Od"
Cohesion: 0.15
Nodes (28): ac(), add(), bs(), concat(), cs(), ds(), fs(), H() (+20 more)
...
### Community 92 - "get"
Cohesion: 0.22
Nodes (13): MapCanvas, CrosshairIcon(), capturePosition(), getSnapshot(), isWatching(), listeners, notify(), startWatch() (+5 more)
...
### Community 96 - "Json"
Cohesion: 0.36
Nodes (7): availableSlug(), createRestaurant(), filterLeads(), normalizeText(), rowToLeadLite(), slugify(), uniqueSlug()
...
### Community 104 - "sub"
Cohesion: 0.09
Nodes (38): A(), ab(), addIndicesForPlacedSymbol(), ax, cx(), db(), dx(), ec() (+30 more)
...
### Community 107 - "y"
Cohesion: 0.18
Nodes (13): containsMaxSafeIntegerValues(), getFeatures(), getTransition(), getValue(), getValueFromBuffer(), offsetToLengthBuffer(), _propertyRootKey(), rc() (+5 more)
...
Cohesion: 0.13
Nodes (22): as(), checkSubtype(), Do(), eachChild(), error(), fr, gr, Ir() (+14 more)
...
### Community 116 - "Bd"
Cohesion: 0.21
Nodes (14): ao(), co(), distance(), eo(), Et(), no(), oo(), pointOnLine() (+6 more)
...
### Community 123 - "yc"
Cohesion: 0.24
Nodes (11): addSymbols(), addToLineVertexArray(), addToSortKeyRanges(), angleTo(), av(), bc(), cc(), dist() (+3 more)
...
Cohesion: 0.33
Nodes (4): collectOffer, pricingSection, plans, stripe

### Community 140 - "_refreshViews"
Cohesion: 0.10
Nodes (21): an(), completeTask(), copy(), deserialize(), df(), en(), ff(), freeBufferAfterUpload() (+13 more)
...
Cohesion: 0.13
Nodes (20): defines(), equals(), Es(), getBinderUniforms(), hc(), height(), _insertCell(), mc() (+12 more)

### Community 143 - "hr"
Cohesion: 0.50
Nodes (4): hr, Kr(), Wr(), zr()

### Community 144 - "recalculate"
Cohesion: 0.40
...
### Community 157 - "getPaintAffectingGlobalStateRefs"
Cohesion: 0.67
...
## Knowledge Gaps
- **439 isolated node(s):** `backend`, `$schema`, `slug`, `name`, `tagline` (+434 more)
...
- **Why does `error()` connect `readPackedEnd` to `subdividePolygonInternal`, `theme-toggle.tsx`, `types.ts`, `readPackedEnd`?**
  _High betweenness centrality (0.194) - this node is a cross-community bridge._
- **Why does `push()` connect `addFeature` to `fg`, `_refreshViews`, `types.ts`, `sp`, `recalculate`, `types.ts`, `zn`, `fromFeature`, `geometryType`, `vh`, `getPaintAffectingGlobalStateRefs`, `sortFeatures`, `eslint.config.mjs`, `constants.ts`, `order-card.tsx`, `update`, `ja`, `must`, `subdividePolygonInternal`, `getChildren`, `shell.tsx`, `addLine`, `th`, `lead-cache.ts`, `Od`, `constructor`, `constructor`, `hasDebugData`, `Od`, `public-menu.ts`, `sub`, `clone`, `b`, `y`, `getValue`, `readPackedEnd`, `getColorRampTextures`, `Bd`, `readVarint`, `yc`, `extend`?**
