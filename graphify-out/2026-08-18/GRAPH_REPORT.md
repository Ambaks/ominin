...
## Corpus Check
- 346 files · ~1,238,554 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2775 nodes · 7118 edges · 153 communities (135 shown, 18 thin omitted)
- Extraction: 96% EXTRACTED · 4% INFERRED · 0% AMBIGUOUS · INFERRED: 262 edges (avg confidence: 0.56)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `8b7cd50c`
...
Cohesion: 0.08
Nodes (60): addActivity(), apply(), availableSlug(), completeTask(), createAppointment(), createRestaurant(), createTask(), DuplicateCandidate (+52 more)

### Community 1 - "createAdminClient"
Cohesion: 0.21
Nodes (15): GET(), GET(), POST(), POST(), GET(), POST(), GET(), POST() (+7 more)
...
### Community 3 - "api.ts"
Cohesion: 0.13
Nodes (45): fetchAllSlugs(), importRestaurants(), updateImportantNotes(), addTableToGroup(), apply(), assertTransition(), createCategory(), createFormule() (+37 more)
...
Cohesion: 0.10
Nodes (19): AnalyticsView, AnalytiquePage(), compact, PostAnalyticsList(), VIEW_SUBTITLES, VIEWS, CreationComptesPage(), ComptesPage() (+11 more)
...
Cohesion: 0.18
Nodes (13): ProduitsPage(), DiscoverLink(), Pill(), ProductCard(), startCheckout(), ROLE_TAGLINES, allowedActions(), activeProducts() (+5 more)
...
Cohesion: 0.09
Nodes (23): containsMaxSafeIntegerValues(), copy(), df(), ff(), freeBufferAfterUpload(), getFeatures(), getTransition(), getValue() (+15 more)
...
Cohesion: 0.08
Nodes (50): AnalytiquePage(), CommandesPage(), dedupeById(), FilterId, FILTERS, matchesFilter(), EquipePage(), ROLES (+42 more)
...
Cohesion: 0.05
Nodes (43): generateMetadata(), getRestaurant, MenuPage(), AddToOrder(), isUnavailable(), OptionsModal(), CartBar(), PaymentChoice (+35 more)

### Community 27 - "selectors.ts"
Cohesion: 0.15
Nodes (15): Period, ApercuPage(), StatCard(), ANALYTICS_PERIOD_DAYS, DayPoint, inProgressOrders(), lineTotal(), ordersByHour() (+7 more)
...
Cohesion: 0.21
Nodes (7): metadata, CollectDemoStage(), DemoHint(), Side, BrowserFrame(), nextActionSide(), demoSection
...
Cohesion: 0.13
Nodes (18): CartLine, cartTotal(), CheckoutDialog(), CollectExperience(), ItemRow(), SelectedChoice, OrderCard(), CashDetails (+10 more)

### Community 58 - "formatPrice"
Cohesion: 0.12
Nodes (22): metadata, LeadPanelHost(), AdminShell(), DESKTOP_ITEMS, FULL_BLEED_PATHS, NAV_ITEMS, signOut(), adminLoginPath() (+14 more)
...
### Community 67 - "Tt"
Cohesion: 0.09
Nodes (26): addSymbols(), av(), Cd(), emplace(), feature(), getId(), getPositionIds(), getPositions() (+18 more)

### Community 68 - "format.ts"
Cohesion: 0.13
Nodes (29): ApercuPage(), dayTitle(), groupByDay(), RdvPage(), STATUS_CLASSES, TabId, PlusIcon(), FollowUpChoice (+21 more)

### Community 69 - "useAdmin"
Cohesion: 0.07
Nodes (30): Analysis, ImportPage(), ParsedRow, Phase, RowStatus, STATUS_META, COLUMNS, exportColumns() (+22 more)
...
Cohesion: 0.17
Nodes (17): _calculate(), ci(), createArrays(), dc(), di(), evaluate(), fc(), Oi() (+9 more)

### Community 74 - "fire"
Cohesion: 0.20
Nodes (12): PlatformBadge(), PostCard(), STATUS_CLASSES, captionsSchema(), generateCaptions(), PLATFORM_LABELS, STATUS_LABELS, CaptionSet (+4 more)

### Community 75 - "push"
Cohesion: 0.11
Nodes (20): EXTENSIONS, POST(), POST(), Product, PRODUCTS_BY_CHOICE, GET(), ClipEspaceLayout(), metadata (+12 more)

### Community 76 - "ja"
Cohesion: 0.18
Nodes (8): PublierPage(), CaptionEditor(), Dropzone(), formatSize(), CheckIcon(), UploadIcon(), ACCEPTED_VIDEO_TYPES, ClipUploadInput
...
Cohesion: 0.10
Nodes (32): InvitationForm(), InvitationPage(), OnboardingForm(), RESERVED_SLUGS, metadata, OnboardingPage(), STATUS_CLASSES, StatusBadge() (+24 more)

### Community 79 - "types.ts"
Cohesion: 0.07
Nodes (45): MapLeadCard(), statusColorExpression, Viewport, StatusMenu(), ALL_COLUMNS, LeadCard(), PipelineBoard(), DragState (+37 more)
...
Cohesion: 0.09
Nodes (24): metadata, NavItem, NAV_ITEMS, NavItem, signOut(), ApercuIcon(), ChartIcon(), CommandesIcon() (+16 more)

### Community 84 - "has"
Cohesion: 0.16
Nodes (16): GET(), BackToLandingLink(), CollectDemoShowcase(), OrderConfirmation(), STATUS_COPY, CartChoice, CartLinePayload, collectDemoHref() (+8 more)

### Community 85 - "addLine"
Cohesion: 0.11
Nodes (25): Aa(), ao(), ba(), bind(), canonicalID(), da(), ea, ga() (+17 more)

### Community 86 - "getStripe"
Cohesion: 0.18
Nodes (19): POST(), POST(), ResolvedLine, resolveOptions(), AccountRow, GET(), paymentAccounts(), POST() (+11 more)
...
Cohesion: 0.22
Nodes (9): _convertFromCellCoord(), _convertToCellCoord(), expandBy(), _forEachCell(), insert(), loadVTLayers(), lookupSymbolFeatures(), query() (+1 more)
...
Cohesion: 0.08
Nodes (38): CartePage(), MapCanvas, RestaurantsPage(), TachesPage(), FilterBar(), CrosshairIcon(), FilterIcon(), SearchIcon() (+30 more)

### Community 94 - "readPackedEnd"
Cohesion: 0.11
Nodes (19): addImages(), as(), backfillBorder(), calculateScaledKey(), constructor(), _down(), getBuffer(), gs (+11 more)

### Community 95 - "constructor"
Cohesion: 0.18
Nodes (13): ap(), cp(), createNewSegment(), getOrCreateLatestSegment(), gp(), ip(), jp(), kp() (+5 more)
...
Cohesion: 0.08
Nodes (26): an(), completeTask(), deserialize(), en(), filter(), fn(), getAndRemove(), _getAndRemoveByKey() (+18 more)

### Community 109 - "Q"
Cohesion: 0.07
Nodes (42): ad, addCurrentVertex(), addHalfVertex(), addLine(), addToLineVertexArray(), addToSortKeyRanges(), am(), angleTo() (+34 more)
...
- **Why does `push()` connect `addFeature` to `recalculate`, `types.ts`, `MenuItem`, `zn`, `getPaintAffectingGlobalStateRefs`, `page.tsx`, `getUniforms`, `eslint.config.mjs`, `demo-showcase.tsx`, `order-card.tsx`, `Tt`, `update`, `theme-toggle.tsx`, `must`, `subdividePolygonInternal`, `getChildren`, `addLine`, `th`, `lead-cache.ts`, `Od`, `get`, `readPackedEnd`, `constructor`, `populate`, `readVarint`, `hasDebugData`, `sub`, `clone`, `loadTile`, `parse`, `getValue`, `Q`, `_refreshViews`, `readPackedEnd`, `uo`, `filterUpdate`, `getColorRampTextures`, `processTask`, `replace`, `fromFeature`, `collectOffer`, `extend`?**
  _High betweenness centrality (0.168) - this node is a cross-community bridge._
