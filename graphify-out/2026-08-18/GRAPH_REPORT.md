...
## Corpus Check
- 345 files · ~1,202,359 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2774 nodes · 7118 edges · 150 communities (136 shown, 14 thin omitted)
- Extraction: 96% EXTRACTED · 4% INFERRED · 0% AMBIGUOUS · INFERRED: 262 edges (avg confidence: 0.56)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `2fa75f98`
...
- [[_COMMUNITY_readPackedEnd|readPackedEnd]]
- [[_COMMUNITY_uo|uo]]
- [[_COMMUNITY_filterUpdate|filterUpdate]]
...
3. `get()` - 56 edges
4. `useToast()` - 47 edges
5. `createAdminClient()` - 45 edges
6. `constructor()` - 42 edges
7. `evaluate()` - 42 edges
8. `must()` - 35 edges
9. `emplaceBack()` - 34 edges
10. `useGestionAccess()` - 33 edges
...
- `InvitationPage()` --calls--> `createClient()`  [EXTRACTED]
  frontend/app/invitation/page.tsx → frontend/lib/supabase/server.ts
...
Cohesion: 0.08
Nodes (61): ActivityInput, addActivity(), apply(), availableSlug(), completeTask(), createAppointment(), createRestaurant(), createTask() (+53 more)
...
### Community 3 - "api.ts"
Cohesion: 0.15
Nodes (42): updateImportantNotes(), addTableToGroup(), apply(), assertTransition(), createCategory(), createFormule(), createGroup(), createItem() (+34 more)
...
Cohesion: 0.12
Nodes (20): CollectSignupForm(), ProduitsPage(), OnboardingForm(), RESERVED_SLUGS, metadata, ExternalLinkIcon(), SubscriptionGate(), DiscoverLink() (+12 more)
...
Cohesion: 0.11
Nodes (27): TachesPage(), FilterBar(), RestaurantPicker(), TaskFormModal(), AppointmentInput, countActiveFilters(), emptyFilters(), filters (+19 more)
...
Cohesion: 0.19
Nodes (18): A(), C(), ct(), D(), E(), jc(), k(), lt() (+10 more)
...
Cohesion: 0.08
Nodes (51): CommandesPage(), dedupeById(), FilterId, FILTERS, matchesFilter(), EquipePage(), ROLES, TeamManager() (+43 more)
...
Cohesion: 0.13
Nodes (17): AddToOrder(), isUnavailable(), OptionsModal(), CartBar(), PaymentChoice, SubmitState, PaymentState, SumUpCardSdk (+9 more)
...
Cohesion: 0.11
Nodes (32): ACTIVE_ORDER_STATUSES, HISTORY_ORDER_STATUSES, assembleCategories(), assembleGroups(), OrderRow, rowToEtablissement(), rowToFormule(), rowToOrder() (+24 more)
...
Cohesion: 0.34
Nodes (14): f(), g(), gl(), ib(), interpolate(), l(), m(), qg() (+6 more)
...
Cohesion: 0.23
Nodes (11): buildDemoMenu(), COLLECT_DEMO, DEMO_MENU_SPEC, DemoMenuSection, demoRestaurantInfo, DemoStep, CollectDemoContext, CollectDemoState (+3 more)
...
Cohesion: 0.12
Nodes (23): metadata, TaskIcon(), LeadPanelHost(), AdminShell(), DESKTOP_ITEMS, FULL_BLEED_PATHS, NAV_ITEMS, signOut() (+15 more)

### Community 63 - "order-card.tsx"
Cohesion: 0.12
Nodes (24): as(), br(), checkSubtype(), Do(), eachChild(), eo(), error(), fr (+16 more)
...
Cohesion: 0.10
Nodes (33): DUPLICATE_REASON_LABELS, CartLine, cartTotal(), CheckoutDialog(), CollectExperience(), ItemRow(), SelectedChoice, ArticleDraft (+25 more)
...
Cohesion: 0.11
Nodes (28): ArrowRightIcon(), CalendarIcon(), ChevronLeftIcon(), ClockIcon(), CrosshairIcon(), FilterIcon(), GlobeIcon(), MailIcon() (+20 more)
...
Cohesion: 0.13
Nodes (25): realloc(), ty(), v(), writeBoolean(), writeBooleanField(), writeBytes(), writeBytesField(), writeDouble() (+17 more)

### Community 73 - "theme-toggle.tsx"
Cohesion: 0.22
Nodes (13): bo(), _calculate(), ci(), evaluate(), Ho(), Oi(), parseColor(), possiblyEvaluate() (+5 more)
...
### Community 75 - "push"
Cohesion: 0.12
Nodes (17): EXTENSIONS, POST(), POST(), Product, PRODUCTS_BY_CHOICE, GET(), CollectEtablissementPage(), metadata (+9 more)
...
Cohesion: 0.06
Nodes (16): al, bt(), dr, dt(), ln(), mn, _n(), pt() (+8 more)

### Community 78 - "loadMatchingFeature"
Cohesion: 0.07
Nodes (44): GET(), InvitationForm(), InvitationPage(), OrderCardDemo(), RestaurantPane(), OrderConfirmation(), STATUS_COPY, OrderCard() (+36 more)

### Community 79 - "types.ts"
Cohesion: 0.07
Nodes (34): statusColorExpression, Viewport, StatusMenu(), ALL_COLUMNS, LeadCard(), PipelineBoard(), DragState, useBoardDrag() (+26 more)
...
Cohesion: 0.12
Nodes (16): metadata, ApercuIcon(), ChartIcon(), CommandesIcon(), EditIcon(), FormulesIcon(), GearIcon(), LogoutIcon() (+8 more)

### Community 84 - "has"
Cohesion: 0.12
Nodes (19): an(), en(), filter(), fn(), getAndRemove(), _getAndRemoveByKey(), has(), jn() (+11 more)

### Community 85 - "addLine"
Cohesion: 0.15
Nodes (18): ba(), bind(), canonicalID(), fo(), ga(), geometry(), ha(), io() (+10 more)

### Community 86 - "getStripe"
Cohesion: 0.18
Nodes (19): POST(), ResolvedLine, resolveOptions(), AccountRow, GET(), paymentAccounts(), POST(), requireGerant() (+11 more)
...
### Community 90 - "Od"
Cohesion: 0.20
Nodes (16): _addCollisionDebugVertex(), addCollisionDebugVertices(), addSymbols(), av(), createNewSegment(), emplaceBack(), forceNewSegmentOnNextPrepare(), getOrCreateLatestSegment() (+8 more)
...
### Community 92 - "get"
Cohesion: 0.10
Nodes (16): Database, TablesInsert, Category, daysAgo(), daysAhead(), db, LeadStatus, main() (+8 more)

### Community 93 - "page.tsx"
Cohesion: 0.21
Nodes (14): CartePage(), MapCanvas, MarkVisitedInput, capturePosition(), getSnapshot(), isWatching(), listeners, notify() (+6 more)

### Community 94 - "readPackedEnd"
Cohesion: 0.11
Nodes (19): addImages(), backfillBorder(), calculateScaledKey(), constructor(), copy(), df(), _down(), ff() (+11 more)
...
Cohesion: 0.20
Nodes (15): bbox(), cm(), decode(), ey(), loadGeometry(), nextField(), readBoolean(), readBytes() (+7 more)
...
Cohesion: 0.23
Nodes (12): b(), determineAverageLineWidth(), determineLineBreaks(), getMaxImageSize(), getMaxScale(), getSection(), getSectionIndex(), hasZeroWidthSpaces() (+4 more)

### Community 104 - "sub"
Cohesion: 0.05
Nodes (80): ac(), add(), ax, bb(), bs(), bx(), concat(), containsPolygonGeometry() (+72 more)

### Community 105 - "clone"
Cohesion: 0.17
Nodes (11): generateMetadata(), getRestaurant, MenuPage(), CategoryLink, CategoryNav(), Hero(), PARTICLES, LANGUAGES (+3 more)

### Community 106 - "loadTile"
Cohesion: 0.12
Nodes (23): addLineDashDependencies(), calculateGlyphDependencies(), constantOr(), evaluateWithoutErrorHandling(), factory(), fromString(), gc, get() (+15 more)
...
### Community 112 - "uo"
Cohesion: 0.26
Nodes (12): co(), distance(), Et(), lo(), pointOnLine(), pop(), Ra(), so() (+4 more)

### Community 113 - "filterUpdate"
Cohesion: 0.29
Nodes (7): createArrays(), dc(), di(), fc(), qc(), toString(), uc()
...
### Community 120 - "theme-toggle.tsx"
Cohesion: 0.32
Nodes (3): ClipNav(), LandingNav(), ThemeToggle()

### Community 121 - "replace"
Cohesion: 0.25
Nodes (8): Bv(), j_(), Kt(), replace(), url(), uv(), Vv(), zv()

### Community 122 - "fromFeature"
Cohesion: 0.17
Nodes (12): Gy(), Hy(), Iy(), Ly(), R, Ry(), Uy(), verticalizePunctuation() (+4 more)
...
## Knowledge Gaps
- **438 isolated node(s):** `backend`, `$schema`, `slug`, `name`, `tagline` (+433 more)
...
- **Why does `refreshOrders()` connect `types.ts` to `order-card.tsx`?**
  _High betweenness centrality (0.168) - this node is a cross-community bridge._
- **Why does `error()` connect `order-card.tsx` to `types.ts`, `icons.tsx`, `types.ts`, `subdividePolygonInternal`?**
  _High betweenness centrality (0.168) - this node is a cross-community bridge._
- **Why does `push()` connect `addFeature` to `recalculate`, `types.ts`, `zn`, `vh`, `page.tsx`, `loading.tsx`, `eslint.config.mjs`, `order-card.tsx`, `Tt`, `update`, `ja`, `must`, `subdividePolygonInternal`, `getChildren`, `has`, `addLine`, `th`, `lead-cache.ts`, `Od`, `get`, `readPackedEnd`, `populate`, `readVarint`, `hasDebugData`, `public-menu.ts`, `sub`, `loadTile`, `parse`, `getValue`, `Q`, `readPackedEnd`, `uo`, `filterUpdate`, `getColorRampTextures`, `replace`, `fromFeature`, `extend`?**
