...
## Corpus Check
- 427 files · ~1,493,729 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3229 nodes · 8263 edges · 178 communities (160 shown, 18 thin omitted)
- Extraction: 96% EXTRACTED · 4% INFERRED · 0% AMBIGUOUS · INFERRED: 312 edges (avg confidence: 0.59)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `235afe41`
...
Cohesion: 0.10
Nodes (31): ApercuPage(), Period, CuisinierApercu(), EmployeeApercu(), EmptyService(), LiveTile(), ProfileRow(), riseDelay() (+23 more)
...
Cohesion: 0.13
Nodes (19): COLUMNS, exportColumns(), MapLeadCard(), LeadCard(), LeadStatusBadge(), PriorityBadge(), TaskRowItem(), CATEGORY_LABELS (+11 more)
...
Cohesion: 0.07
Nodes (35): ProduitsPage(), OnboardingForm(), RESERVED_SLUGS, metadata, OnboardingPage(), ApercuIcon(), BellIcon(), CommandesIcon() (+27 more)
...
Cohesion: 0.29
Nodes (10): availableSlug(), createRestaurant(), fetchOutreachStats(), findDuplicates(), updateCashDetails(), voidCashPayment(), rowToOrder(), fetchOrderHistory() (+2 more)
...
Cohesion: 0.15
Nodes (11): providerApiKey(), CAPTION_FIELDS, ClipProvider, ensureProfile(), isClipPlatform(), listConnectedAccounts(), RawAnalytics, RawPostPlatform (+3 more)
...
Cohesion: 0.09
Nodes (33): ChimeCard(), DevicesCard(), DeviceStatusCard(), IOS_STEPS, PrefsCard(), armedListeners, CHIME_NOTES, chimeEnabled() (+25 more)

### Community 25 - "icons.tsx"
Cohesion: 0.09
Nodes (43): InvitationForm(), InvitationPage(), NavItem, ACTION_FEATURE, ACTION_LABELS, ANALYTICS_PERIOD_DAYS, COLLECT_FEATURES, EXCLUDED_STATUSES (+35 more)
...
Cohesion: 0.09
Nodes (15): metadata, metadata, metadata, metadata, metadata, InscriptionTabs(), Profile, TABS (+7 more)
...
Cohesion: 0.11
Nodes (21): bp(), containsPolygonGeometry(), defines(), Es(), geometryType(), getBinderUniforms(), getBinding(), getGeometries() (+13 more)
...
Cohesion: 0.06
Nodes (73): ActivityInput, AppointmentInput, DuplicateCandidate, ExportRow, fetchAllSlugs(), fetchAppointments(), fetchExportRows(), fetchLatestResearchRun() (+65 more)
...
Cohesion: 0.10
Nodes (29): LeaPage(), EtablissementForm(), MenuPage(), View, StatusMenu(), FollowUpChoice, CreateRestaurantModal(), DUPLICATE_REASON_LABELS (+21 more)
...
Cohesion: 0.11
Nodes (15): AnalyticsView, AnalytiquePage(), compact, PostAnalyticsList(), VIEW_SUBTITLES, VIEWS, CreationComptesPage(), PublierPage() (+7 more)
...
Cohesion: 0.11
Nodes (35): ApercuPage(), dayTitle(), groupByDay(), RdvPage(), STATUS_CLASSES, TabId, PlusIcon(), VisitedFlow() (+27 more)
...
Cohesion: 0.09
Nodes (31): ArrowRightIcon(), BotIcon(), CalendarIcon(), ChevronLeftIcon(), ClockIcon(), GlobeIcon(), MailIcon(), MapPinIcon() (+23 more)

### Community 71 - "update"
Cohesion: 0.15
Nodes (18): CallBody, POST(), POST(), POST(), DispatchBody, PUSH_EVENTS, PushEvent, PushPayload (+10 more)
...
### Community 75 - "push"
Cohesion: 0.11
Nodes (25): CartePage(), MapCanvas, EmailsRedirect(), ImportPage(), metadata, RestaurantsPage(), TachesPage(), CrosshairIcon() (+17 more)
...
Cohesion: 0.14
Nodes (14): appendLeaves(), cluster(), createIndex(), createTree(), getChildren(), getClusterExpansionZoom(), getLeaves(), getOriginId() (+6 more)
...
### Community 90 - "Od"
Cohesion: 0.12
Nodes (23): approveOutreachEmail(), promoteVariant(), rejectOutreachEmail(), updateOutreachDraft(), updateVariantStatus(), claimDevice(), CONSTRAINT_MESSAGES, createPrinter() (+15 more)
...
Cohesion: 0.11
Nodes (27): CommandesPage(), dedupeById(), EMPTY_BODIES, FilterId, FILTERS, matchesFilter(), EquipePage(), ROLES (+19 more)

### Community 94 - "readPackedEnd"
Cohesion: 0.07
Nodes (38): DayGroup, dedupeById(), displayMode(), groupByDay(), matchesMode(), MODE_FILTERS, ModeFilter, PaiementsPage() (+30 more)
...
### Community 96 - "Json"
Cohesion: 0.12
Nodes (17): ClipEspaceLayout(), metadata, NavItem, Dropzone(), formatSize(), CheckIcon(), LinkIcon(), ListIcon() (+9 more)
...
Cohesion: 0.06
Nodes (34): generateMetadata(), getRestaurant, MenuPage(), AddToOrder(), isUnavailable(), OptionsModal(), CallServerButton(), CallState (+26 more)
...
Cohesion: 0.18
Nodes (11): GET(), EXTENSIONS, POST(), POST(), Product, PRODUCTS_BY_CHOICE, GET(), CollectSignupForm() (+3 more)
...
Cohesion: 0.07
Nodes (30): completeTask(), containsMaxSafeIntegerValues(), copy(), deserialize(), df(), ff(), freeBufferAfterUpload(), getFeatures() (+22 more)
...
### Community 106 - "b"
Cohesion: 0.20
Nodes (11): parseProducts(), POST(), Product, upsertSubscription(), CompositeTypes, Constants, Database, DatabaseWithoutInternals (+3 more)
...
### Community 109 - "Yf"
Cohesion: 0.07
Nodes (37): CartLine, cartTotal(), CheckoutDialog(), CollectExperience(), ItemRow(), SelectedChoice, OrderCardDemo(), RestaurantPane() (+29 more)
...
### Community 116 - "Bd"
Cohesion: 0.18
Nodes (11): POST(), CaptionEditor(), captionsSchema(), generateCaptions(), ClipUploadInput, CaptionSet, ClipPlatform, PlatformResult (+3 more)
...
Cohesion: 0.14
Nodes (11): Analysis, ParsedRow, Phase, RowStatus, STATUS_META, ImportIcon(), PillTab, PillTabs() (+3 more)
...
### Community 148 - "vh"
Cohesion: 0.25
Nodes (5): metadata, collectOffer, pricingSection, plans, stripe
...
## Knowledge Gaps
- **470 isolated node(s):** `backend`, `$schema`, `slug`, `name`, `tagline` (+465 more)
...
- **Why does `error()` connect `readPackedEnd` to `subdividePolygonInternal`, `icons.tsx`, `get`, `types.ts`?**
  _High betweenness centrality (0.196) - this node is a cross-community bridge._
- **Why does `push()` connect `eslint.config.mjs` to `Yf`, `populate`, `data.ts`, `types.ts`, `addFeature`, `collectOffer`, `sb`, `MenuItem`, `shell.tsx`, `_getByteView`, `page.tsx`, `sortFeatures`, `addLine`, `_getWorkerSource`, `types.ts`, `Ta`, `page.tsx`, `O`, `getPaintAffectingGlobalStateRefs`, `database.types.ts`, `must`, `subdividePolygonInternal`, `has`, `addLine`, `th`, `get`, `constructor`, `wordmark.tsx`, `processTask`, `clone`, `getValue`, `readPackedEnd`, `y`, `getColorRampTextures`, `replace`, `extend`?**
